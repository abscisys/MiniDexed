...
if(RPI GREATER 2)
    ...
    set(TOOLCHAIN_URL "https://developer.arm.com/-/media/Files/downloads/gnu/13.3.rel1/binrel/arm-gnu-toolchain-13.3.rel1-x86_64-aarch64-none-elf.tar.xz" CACHE STRING "Toolchain URL")
else()
    set(TOOLCHAIN_NAME "arm-none-eabi" CACHE STRING "Toolchain name")
    message(STATUS "Using toolchain ${TOOLCHAIN_NAME}")
    set(TOOLCHAIN_PREFIX "${TOOLCHAIN_NAME}-" CACHE STRING "Toolchain prefix")
    set(TOOLCHAIN_URL "https://developer.arm.com/-/media/Files/downloads/gnu/13.3.rel1/binrel/arm-gnu-toolchain-13.3.rel1-x86_64-arm-none-eabi.tar.xz" CACHE STRING "Toolchain URL")
endif()
...
string(REGEX MATCH "arm-gnu-[^/]*" TOOLCHAIN_DIR ${TOOLCHAIN_FILENAME_NO_EXT})
